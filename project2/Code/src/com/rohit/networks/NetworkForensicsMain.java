	...
	public static void main(String[] args) throws IOException {
		...
		while (System.in.available() > 0) {
			...
			if (pcapData.ipHeader.TransportLayerProtocol == ConstantsEnum.TCP) {
				...
				System.out.println("ddd:"+pcapData.ipHeader.Source.hashCode());
				
				StringBuilder src = new StringBuilder();
				src.append(pcapData.ipHeader.Source).append(":").append(pcapData.transportHeader.SourcePort);
				StringBuilder dest = new StringBuilder();
				src.append(pcapData.ipHeader.Destination).append(":").append(pcapData.transportHeader.DestinationPort);
...
//				s2 = "\n" + s2;
		...
		if (taskNumber == 1) {
			...
			System.out.println("asd" + tcpConnections.size());
